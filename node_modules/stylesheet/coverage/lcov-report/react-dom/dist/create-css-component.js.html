...
<html lang="en">
<head>
    <title>Code coverage report for react-dom/dist/create-css-component.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">react-dom/dist</a> create-css-component.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
var _extends = Object.assign || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >fu</span>nction (target) { <span class="cstat-no" title="statement not covered" >for (var i = 1; i &lt; arguments.length; i++) { var source = <span class="cstat-no" title="statement not covered" >arguments[i];</span> <span class="cstat-no" title="statement not covered" >for (var key in source) { <span class="cstat-no" title="statement not covered" >if (Object.prototype.hasOwnProperty.call(source, key)) { <span class="cstat-no" title="statement not covered" >target[key] = source[key]; </span>} </span>} </span>} <span class="cstat-no" title="statement not covered" ></span>return target; </span>};</span>
&nbsp;
...
&nbsp;
  var displayName = _ref.displayName,
      ...
      attrs = _ref.attrs,
      _ref$base = _ref.base,
      base = _ref$base === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >'div' </span>: _ref$base,
...
&nbsp;
      var _this = _possibleConstructorReturn(this, (CSSComponent.__proto__ || <span class="branch-1 cbranch-no" title="branch not covered" >Object.getPrototypeOf(CSSComponent))</span>.call(this, props));
&nbsp;
...
&nbsp;
    _createClass(CSSComponent, [{
      ...
      value: function <span class="fstat-no" title="function not covered" >componentWillUpdate(</span>nextProps) {
<span class="cstat-no" title="statement not covered" >        this.applyAttrs(nextProps);</span>
      }
    }, {
      key: 'componentWillUnmount',
      value: function <span class="fstat-no" title="function not covered" >componentWillUnmount(</span>) {
<span class="cstat-no" title="statement not covered" >        _hot2.default.unregister(this);</span>
      }
&nbsp;
...
&nbsp;
      ...
      key: 'render',
      value: function <span class="fstat-no" title="function not covered" >render(</span>) {
        var props = <span class="cstat-no" title="statement not covered" >this.props;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return (0, _react.createElement)(this.constructor.base, _extends({</span>
          ref: props.innerRef
...
&nbsp;
      try {
        for (var _iterator = _this2.attrs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var attr = <span class="cstat-no" title="statement not covered" >_step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          attr.cssRule.style[attr.prop] = (0, _template.format)(attr.template, props);</span>
        }
      } catch (err) {
...
&nbsp;
    this.shouldOmitProp = <span class="fstat-no" title="function not covered" >fu</span>nction (value, key) {
<span class="cstat-no" title="statement not covered" >      return _this2.constructor.invalidProps[key] || key === 'innerRef';</span>
    };
  }, _temp;
};
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat Jul 15 2017 01:03:15 GMT+0300 (IDT)
</div>
</div>
